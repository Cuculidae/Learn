 ...
 * For alternate implementations of the same API, see TarjanSCC and GabowSCC.
 * For additional documentation, see <href="/algs4/42digraph">
 *
 * Execution:       java KosarajuSharirSCC INPUT.TXT
 ...
 *                  10 
 *
 *                  % java -Xss50m KosarajuSharirSCC largeDG.txt 
 *                  25 components
 ...
 *
 * Dependencies:    Digraph.java, DepthFirstOrder.java, Queue.java, In.java, StdOut.java
...
public class KosarajuSharirSCC
{
     ...
     *********************************************************************************************/
    // Unit-test KosarajuSharirSCC data type
