 ...
 * This implementation uses the Tarjan's algorithm.
 ...
 * For alternate implementations of the same API, see KosarajuSharirSCC and GabowSCC.
 * For additional documentation, see <href="/algs4/42digraph">
 *
 * Execution:       java TarjanSCC INPUT.TXT
 ...
 *                  10 
 *
 *                  % java -Xss50m TarjanSCC largeDG.txt 
 *                  25 components
...
public class TarjanSCC
{
    ...
    private int dfn;                // preorder counter
     ...
     *********************************************************************************************/
    // Unit-test the TarjanSCC data type
