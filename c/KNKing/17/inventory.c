 ...
 * inventory.c
 * Depencies: readline.c readline.h
 * Compilation: gcc -o inventory inventory.c readline.c
 * Created: 2015-08-31
 */
 ...
 *         the part into the inventory list. Prints an error message and       *
 *         returns prematurely if the part already exists or space could not   *
 ...
 *         the part in the database. If the part exists, prints the name and   *
...
/*******************************************************************************
 * destruct: Destroy the inventory linked list.                                *
 ******************************************************************************/
void destruct(void)
{
    struct part *p, *next;
    for (p = inventory; p != NULL; p = next) {
        next = p->next;
        free(p);
    }
}
